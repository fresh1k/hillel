...
// return category.forEach(product => {
// document.write(
// `<tr class="products">
// <td><img src="images/${this.name}/${product.type}.svg" alt="${product.type}" width="50" height="50"></td>
// <td>${product.type}</td>
// <td><b>${Array.isArray(product.price) ? `${product.price[0]} - ${product.price[product.price.length - 1]}` : product.price} USD</b></td>
// </tr>`
// )
// });
// }
...
// let mebel = new Product(furniture);
// mebel.name = 'furniture';
// mebel.render();

// let device = new Product(devices);
// device.name = 'devices';
// device.render();

// let appliance = new Product(appliances)
// appliance.name = 'appliances';
// appliance.render();
